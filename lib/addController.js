...
AddController.prototype.unknownAction = function(route, action) {
    console.log("Unknown add parameter. Valid ones are: admin, app, context, object");
};
...
AddController.prototype.admin = function(callback) {
    ...
    var self = this;
    this.helpers.doTelepatRequest("/admin/add", post_data, function(parsedResponse) {
...
AddController.prototype.object = function(callback) {
    ...
    var object = this.arguments.objectContents;
    var appId = this.helpers.retrieveArgument('appId', this.arguments);
    if(modelName === undefined || contextId === undefined || object === undefined || appId === undefined) {
        console.log("modelName, contextId and objectContents are required");
        return;
    }
    // console.log(object);
    // return;
    ...
    this.helpers.doTelepatRequest("/object/create", JSON.stringify(post_data), function(response) {
